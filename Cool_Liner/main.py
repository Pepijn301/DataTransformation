...
df = pd.read_csv('prices.csv', sep="^", names=[
    ...
    "nto+kosten", "wholesale2", "dealer2", "end_user2", "ship_cat", "virtueel gewicht", "echt gewicht", "afmetingen", "car_make",
    "car_category", "car_sub_category", "car_category2", "body1", "body_en", "body_de", "body_nl", "title_en", "title_de", "title_nl",
...
car_df = df[["car_model", "car_years", "car_category", "car_sub_category", "car_make", "body1"]]
